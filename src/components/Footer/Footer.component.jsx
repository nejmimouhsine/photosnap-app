...
import { MenuItemsFooter } from '../Navbar/MenuItems';
        ...
        <div className="footer">
            ...
            <div className="footer__copy">
                <Button className="footer__btn" type="submit">
                    get an invite
                    <svg className="footer__arrow" xmlns="http://www.w3.org/2000/svg" width="43" height="14"><g fill="none" fillRule="evenodd" stroke="#000"><path d="M0 7h41.864M35.428 1l6 6-6 6"/></g></svg>
                </Button>

                <p className="footer__paragraph">Copyright {date.getFullYear()}. All Rights Reserved</p>
            </div>
        </div>
    )
}
